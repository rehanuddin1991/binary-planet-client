...
const FeaturedProducts = () => {
    return (<div className='dark:bg-[#272e36] dark:text-[white]'>
    <div className='flex p-2 items-center justify-center xs:text-xl text-3xl text-[indigo] dark:text-[white] mt-14 font-semibold'>
        <h1>Featured Products </h1>
        
    </div>
        <div className='  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 pb-2 mt-3  md:ml-10'>
