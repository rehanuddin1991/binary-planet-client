...
const Footer = () => {
  return (
    <>  
    <footer className="dark:bg-[#1D232A] dark:text-[white] mt-14 font-semibold footer bg-[#F2F4F8] text-[darkcyan] text-[1rem] p-10 justify-around">
  <nav>
...
<div className="mt-6 text-center">
          <p className='text-[indigo] dark:text-[white]'>All rights reserved &copy; Binary Planet Ltd.</p>
        </div>
</>
  )
}
